 ...
 */
public class CreateSizeChangedObserver implements CreateCurlView.SizeChangedObserver {
	float H;
	float W;
	private CreateCurlView mCurlView;
	String bitUrl;
	public CreateSizeChangedObserver(CreateCurlView mCurlView,String bitUrl){
