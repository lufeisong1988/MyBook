 ...
 * @author harism
 */
public class VistCurlView extends GLSurfaceView implements View.OnTouchListener,
	...
	private VistSizeChangedObserver mSizeChangedObserver;
	 ...
	 * Default constructor.
	 */
	public VistCurlView(Context ctx) {
		super(ctx);
		init(ctx);
		this.ctx = ctx;
	}
	 ...
	 * Default constructor.
	 */
	public VistCurlView(Context ctx, AttributeSet attrs) {
		super(ctx, attrs);
		init(ctx);
		this.ctx = ctx;
	}
	 ...
	 * Default constructor.
	 */
	public VistCurlView(Context ctx, AttributeSet attrs, int defStyle) {
		this(ctx, attrs);
		this.ctx = ctx;
	}
	 ...
	 */
	public void setSizeChangedObserver(VistSizeChangedObserver observer) {
