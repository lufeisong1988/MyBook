...
//	AnimationDrawable anim;
	 ...
	 * @param mJavaBean
	 * @param section
	 * @param refresh 1:获取最新的第一页数据，加入页面缓存中,便于下次打开直接显示。2：上拉更多，加入8M缓存中。
	 */
	public BookShelfAdapter(Context mContext,JavaBean mJavaBean,String section,int refresh){
		...
		minHeight = (dm.heightPixels - BookUtils.dip2px(mContext, 65)) / 2;
...
//		anim = (AnimationDrawable) mContext.getResources().getDrawable(R.drawable.animation_list);
	}
	@Override
	public int getCount() {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final ImageView iv1_cover = (ImageView)convertView. findViewById(R.id.button_1_cover);
		...
		final LinearLayout contain1_cover =(LinearLayout)convertView. findViewById(R.id.ll1_cover);
		contain1_cover.setVisibility(View.GONE);
		...
		if(position > 0){
			left.setBackgroundResource(R.drawable.mainbook_left2);
			right.setBackgroundResource(R.drawable.mainbook_right2);
			ll.setBackgroundResource(R.drawable.mainbook_center2);
		}
		...
		if(4*position+1 < bookCoverList.size() || 4*position+1 == bookCoverList.size()){
			...
			if (bit != null) {
				...
				LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(iv1.getWidth(), iv1.getHeight());
				iv1_cover.setLayoutParams(params);
//				iv1_cover.setBackgroundDrawable(anim);
...
//				anim.start();
		...
		iv1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!Utils.isFastDoubleClick()){
					((MainActivity)mContext).loading(contain1_cover,iv1_cover,bookIdList.get(4*position+0),contain1,iv1,x,y,iv1.getWidth(),iv1.getHeight(),bookUpdateTime.get(4*position+0),bookNameList.get(4*position + 0),bookCoverList.get(4*position + 0),false);
				}
			}
		});
		iv2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((MainActivity)mContext).loading(contain1_cover,iv1_cover,bookIdList.get(4*position+1),contain2,iv2,x,y,iv2.getWidth(),iv2.getHeight(),bookUpdateTime.get(4*position+1),bookNameList.get(4*position + 1),bookCoverList.get(4*position + 1),false);
				}
			}
		});
		iv3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((MainActivity) mContext).loading(contain1_cover,iv1_cover,bookIdList.get(4*position+2),contain3,iv3,x,y,iv3.getWidth(),iv3.getHeight(),bookUpdateTime.get(4*position+2),bookNameList.get(4*position + 2),bookCoverList.get(4*position + 2),false);
				}
			}
		});
		iv4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
				((MainActivity)mContext).loading(contain1_cover,iv1_cover,bookIdList.get(4*position+3),contain4,iv4,x ,y,iv4.getWidth(),iv4.getHeight(),bookUpdateTime.get(4*position+3),bookNameList.get(4*position + 3),bookCoverList.get(4*position + 3),false);
				}
			}
		});
		iv1.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((MainActivity)mContext).loading(contain1_cover,iv1_cover,bookIdList.get(4*position+0),contain1,iv1,x,y,iv1.getWidth(),iv1.getHeight(),bookUpdateTime.get(4*position+0),bookNameList.get(4*position + 0),bookCoverList.get(4*position + 0),true);
				}
				return true;
			}
		});
		iv2.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((MainActivity)mContext).loading(contain1_cover,iv1_cover,bookIdList.get(4*position+1),contain2,iv2,x,y,iv2.getWidth(),iv2.getHeight(),bookUpdateTime.get(4*position+1),bookNameList.get(4*position + 1),bookCoverList.get(4*position + 1),true);
				}
				return true;
			}
		});
		iv3.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((MainActivity) mContext).loading(contain1_cover,iv1_cover,bookIdList.get(4*position+2),contain3,iv3,x,y,iv3.getWidth(),iv3.getHeight(),bookUpdateTime.get(4*position+2),bookNameList.get(4*position + 2),bookCoverList.get(4*position + 2),true);
				}
				return true;
			}
		});
		iv4.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((MainActivity)mContext).loading(contain1_cover,iv1_cover,bookIdList.get(4*position+3),contain4,iv4,x ,y,iv4.getWidth(),iv4.getHeight(),bookUpdateTime.get(4*position+3),bookNameList.get(4*position + 3),bookCoverList.get(4*position + 3),true);
				}
				return true;
			}
		});
