...
import com.starbaby.diyBook.main.WorkingShow;
...
public class BookShelfAdapter4 extends BaseAdapter{
	...
	public BookShelfAdapter4(Context mContext,JavaBean2 mJavaBean,String section,int refresh){
		...
		minWidth = (dm.widthPixels - BookUtils.dip2px(mContext, 248));
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView = inflate.inflate(R.layout.shelf_list_item3, null);
		final ImageView iv1 =(ImageView)convertView. findViewById(R.id.work_button_1);
		final ImageView iv2 =(ImageView)convertView. findViewById(R.id.work_button_2);
		final ImageView iv3 =(ImageView)convertView. findViewById(R.id.work_button_3);
		final ImageView iv4 =(ImageView)convertView. findViewById(R.id.work_button_4);
		...
		ImageView left = (ImageView)convertView. findViewById(R.id.work_shelf_image_left);
		ImageView right = (ImageView)convertView. findViewById(R.id.work_shelf_image_right);
		LinearLayout ll = (LinearLayout)convertView. findViewById(R.id.work_linearLayout1);
		...
		final LinearLayout contain1 =(LinearLayout)convertView. findViewById(R.id.work_ll1);
		final LinearLayout contain2 =(LinearLayout)convertView. findViewById(R.id.work_ll2);
		final LinearLayout contain3 =(LinearLayout)convertView. findViewById(R.id.work_ll3);
		final LinearLayout contain4 =(LinearLayout)convertView. findViewById(R.id.work_ll4);
		if(position > 0){
			left.setBackgroundResource(R.drawable.work_shelf_left2);
			right.setBackgroundResource(R.drawable.work_shelf_right2);
			ll.setBackgroundResource(R.drawable.work_shelf_center2);
		}
		...
		iv1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!Utils.isFastDoubleClick()){
					((WorkingShow)mContext).loading(bookIdList.get(4*position+0),contain1,iv1,x,y,iv1.getWidth(),iv1.getHeight(),bookUpdateTime.get(4*position+0),bookNameList.get(4*position + 0),bookCoverList.get(4*position + 0),false);
				}
			}
		});
		iv2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((WorkingShow)mContext).loading(bookIdList.get(4*position+1),contain2,iv2,x,y,iv2.getWidth(),iv2.getHeight(),bookUpdateTime.get(4*position+1),bookNameList.get(4*position + 1),bookCoverList.get(4*position + 1),false);
				}
			}
		});
		iv3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((WorkingShow)mContext).loading(bookIdList.get(4*position+2),contain3,iv3,x,y,iv3.getWidth(),iv3.getHeight(),bookUpdateTime.get(4*position+2),bookNameList.get(4*position + 2),bookCoverList.get(4*position + 2),false);
				}
			}
		});
		iv4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((WorkingShow)mContext).loading(bookIdList.get(4*position+3),contain4,iv4,x,y,iv4.getWidth(),iv4.getHeight(),bookUpdateTime.get(4*position+3),bookNameList.get(4*position + 3),bookCoverList.get(4*position + 3),false);
				}
			}
		});
		iv1.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((WorkingShow)mContext).loading(bookIdList.get(4*position+0),contain1,iv1,x,y,iv1.getWidth(),iv1.getHeight(),bookUpdateTime.get(4*position+0),bookNameList.get(4*position + 0),bookCoverList.get(4*position + 0),true);
				}
				return true;
			}
		});
		iv2.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((WorkingShow)mContext).loading(bookIdList.get(4*position+1),contain2,iv2,x,y,iv2.getWidth(),iv2.getHeight(),bookUpdateTime.get(4*position+1),bookNameList.get(4*position + 1),bookCoverList.get(4*position + 1),true);
				}
				return true;
			}
		});
		iv3.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((WorkingShow)mContext).loading(bookIdList.get(4*position+2),contain3,iv3,x,y,iv3.getWidth(),iv3.getHeight(),bookUpdateTime.get(4*position+2),bookNameList.get(4*position + 2),bookCoverList.get(4*position + 2),true);
				}
				return true;
			}
		});
		iv4.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				int y = location[1];
				if(!Utils.isFastDoubleClick()){
					((WorkingShow)mContext).loading(bookIdList.get(4*position+3),contain4,iv4,x,y,iv4.getWidth(),iv4.getHeight(),bookUpdateTime.get(4*position+3),bookNameList.get(4*position + 3),bookCoverList.get(4*position + 3),true);
				}
				return true;
			}
		});
