...
/**
 * 控制 每个分类下书本封面的缓存 线程2(爱做书 作品秀)
 * @author Administrator
 *
 */
public class CoverThreadPool2 {
	private static CountDownLatch latch;
	Context mContext;
	String section;
	ArrayList<String> bookCoverList;
	public CoverThreadPool2(Context mContext,ArrayList<String> bookCoverList,String section){
	...
	public void saveCover(){
		Thread thread = new Thread(){
			...
			@Override
			public void run() {
				Log.i("bookCoverList_2",bookCoverList.size() + "");
